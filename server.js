...
function updateBook(req, res, next) {
    ...
    db.oneOrNone('UPDATE Books SET title=${title}, author=${author}, isbn=${isbn}, price=${price}, coursename=${coursename}, name=${name}, emailaddress=${emailaddress}, userid=${userid} WHERE id=${id} RETURNING id', {
        ...req.body,
        id: req.params.id,
    })
    .then(data => {
