...
async function createBook(req, res, next) {
  ...
  db.one('INSERT INTO Books(ID, title, author, isbn, courseName, userID, price, front_picture, condition) VALUES (${ID}, ${title}, ${author}, ${isbn}, ${coursename}, ${userID}, ${price}, ${front_picture}, ${condition}) RETURNING id', req.body)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
