...
function createBook(req, res, next) {
  db.one('INSERT INTO Books(ID, title, author, isbn, courseName, userID, price, condition, front_picture) VALUES (${ID}, ${title}, ${author}, ${isbn}, ${coursename}, ${userID}, ${price}, ${condition}, ${front_picture}) RETURNING id', req.body)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
