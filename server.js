...
function createBook(req, res, next) {
  db.one('INSERT INTO Books(ID, title, author, isbn, courseName, condition, userID, price) VALUES (${ID}, ${title}, ${author}, ${isbn}, ${coursename}, ${condition}, ${userID}, ${price}) RETURNING id', req.body)
    .then((data) => {
      res.send(data);
    })
    .catch((err) => {
